...
export const tanstackExample = githubPath({ path: "examples/tanstack-db-sync" });
...
<div class="flex flex-col gap-4">
  ...
  <Card title="Integrations" icon="puzzle">
    ...
    <div class="pt-4 m-0 gap-4 grid grid-cols-7 justify-center items-start">
      ...
      <a href="https://github.com/trailbaseio/trailbase/tree/main/client/swift/trailbase">
      ...
      <a href="https://github.com/trailbaseio/trailbase/tree/main/client/go/trailbase">
  ...
  <CardGrid>
    ...
    <Card title="Realtime Sync" icon="cloud-download">
      ...
      integration out-of-the-box, check out the <a href={tanstackExample}>example</a>.
