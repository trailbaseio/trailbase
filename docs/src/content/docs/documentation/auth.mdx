...
All clients expose this as a `register` method, which registers the account but
...
await client.register({ email: "alice@example.com", password: "s3cr3t!" });

// Username-only accounts have nothing to verify and can sign in right away.
await client.register({ username: "alice", password: "s3cr3t!" });
await client.login("alice", "s3cr3t!");
`;

export const registerDart = `
await client.register(email: 'alice@example.com', password: 's3cr3t!');
`;

export const registerSwift = `
try await client.register(password: "s3cr3t!", email: "alice@example.com")
`;

export const registerKotlin = `
client.register(password = "s3cr3t!", email = "alice@example.com")
`;

export const registerDotnet = `
await client.Register(password: "s3cr3t!", email: "alice@example.com");
`;

export const registerRust = `
client
...
export const registerGo = `
email := "alice@example.com"
err := client.Register(trailbase.RegisterOptions{
	Password: "s3cr3t!",
	Email:    &email,
})
`;

export const registerPy = `
client.register(password="s3cr3t!", email="alice@example.com")
`;

export const registerCurl = `
curl
...
<Tabs>
  <TabItem label="JS/TS">
    <Code lang="ts" code={registerTs} />
  </TabItem>

  <TabItem label="Dart">
    <Code lang="dart" code={registerDart} />
  </TabItem>

  <TabItem label="Swift">
    <Code lang="swift" code={registerSwift} />
  </TabItem>

  <TabItem label="Kotlin">
    <Code lang="kotlin" code={registerKotlin} />
  </TabItem>

  <TabItem label="C#/.NET">
    <Code lang="cs" code={registerDotnet} />
  </TabItem>

  <TabItem label="Rust">
    <Code lang="rust" code={registerRust} />
  </TabItem>

  <TabItem label="Go">
    <Code lang="go" code={registerGo} />
  </TabItem>

  <TabItem label="Python">
    <Code lang="python" code={registerPy} />
  </TabItem>

  <TabItem label="curl">
    <Code lang="sh" frame="code" code={registerCurl} />
  </TabItem>
</Tabs>
