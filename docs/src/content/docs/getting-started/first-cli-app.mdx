...
<Aside type="note" title="Running TrailBase">
  You can either downloaded the latest pre-built
  [release](https://github.com/trailbaseio/trailbase/releases/)
  or use docker, like in the previous section, to run arbitrary TrailBase
  commands:
