...
V8's isolates and JIT are expensive, thus they're typically reused across
...
We expect this to provide immediate safety benefits for users.
...
in the future.
Independently and maybe more importantly, [WASI](https://wasi.dev/) makes it straightforward to
...
We're planning to extend I/O capabilities over time on a per-need basis.
...
As mentioned before, switching off V8 removes a lot of high-scrutiny code and
