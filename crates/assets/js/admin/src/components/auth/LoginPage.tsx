...
function OTPVerification(props: OTPVerificationProps) {
  ...
  return (
    ...
    >
      <h1>OTP Login</h1>
      <p>
        Please enter the OTP code sent to your email <b>{props.email}</b>.
      </p>

      <TextField class="flex items-center gap-2">
        <TextFieldLabel>Code</TextFieldLabel>

        <TextFieldInput type="text" ref={otpInput} />
      </TextField>

      <div class="flex justify-end gap-2">
        <Button type="button" onClick={() => props.setLoginType("pw")}>
          Back
        </Button>
...
function TOTPVerification(props: TOTPVerificationProps) {
  ...
  return (
    ...
    >
      ...
      <div class="flex justify-end gap-2">
        <Button type="button" onClick={() => props.setLoginType("otp")}>
          Back
        </Button>
