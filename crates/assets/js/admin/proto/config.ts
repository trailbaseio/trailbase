...
export enum SmtpEncryption {
  /** SMTP_ENCRYPTION_UNSPECIFIED - Reserved for protobuf default */
  SMTP_ENCRYPTION_UNSPECIFIED = 0,
...
export function smtpEncryptionFromJSON(object: any): SmtpEncryption {
  switch (object) {
    case 0:
    case "SMTP_ENCRYPTION_UNSPECIFIED":
      return SmtpEncryption.SMTP_ENCRYPTION_UNSPECIFIED;
    case 1:
...
export function smtpEncryptionToJSON(object: SmtpEncryption): string {
  switch (object) {
    case SmtpEncryption.SMTP_ENCRYPTION_UNSPECIFIED:
      return "SMTP_ENCRYPTION_UNSPECIFIED";
